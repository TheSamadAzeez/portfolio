  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative flex aspect-square items-center justify-center rounded-full border border-white/20 bg-white/20 shadow-lg backdrop-blur-xl dark:border-white/10 dark:bg-black/20"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className="absolute -top-8 left-1/2 w-fit rounded-md border border-white/20 bg-white/20 px-2 py-0.5 text-xs whitespace-pre text-neutral-700 shadow-lg backdrop-blur-xl dark:border-white/10 dark:bg-black/20 dark:text-white"
            >
              {title}
            </motion.div>
          )}
